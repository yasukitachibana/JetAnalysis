...
public:
  ...
  FourVector(std::vector<double> a) // constructor with array input
  {
    tv = a[0];
    xv = a[1];
    yv = a[2];
  ...
  FourVector(std::array<double, 4> a) // constructor with array input
  {
    tv = a[0];
    xv = a[1];
    yv = a[2];
