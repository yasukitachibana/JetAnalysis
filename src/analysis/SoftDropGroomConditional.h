#ifndef SOFTDROPGROOMCONDITIONAL_H
#define SOFTDROPGROOMCONDITIONAL_H
...
class SoftDropGroomConditional : public AnalysisModuleStandard
{
private:
  // Allows the registration of the module so that it is available to be used by the Analysis framework.
  static RegisterAnalysisModule<SoftDropGroomConditional> reg;
...
public:
  SoftDropGroomConditional(std::string name_in = "SoftDropGroomConditional");
  ~SoftDropGroomConditional();
  std::string Name() { return name; }
};

#endif // SoftDropGroomConditional_H
