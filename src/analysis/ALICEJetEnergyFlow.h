#ifndef ALICEJETENERGYFLOW_H
#define ALICEJETENERGYFLOW_H
...
class ALICEJetEnergyFlow : public AnalysisModuleStandard
{
private:
  // Allows the registration of the module so that it is available to be used by the Analysis framework.
  static RegisterAnalysisModule<ALICEJetEnergyFlow> reg;
...
public:
  ALICEJetEnergyFlow(std::string name_in = "ALICEJetEnergyFlow");
  ~ALICEJetEnergyFlow();
  std::string Name() { return name; }
};

#endif // ALICEJetEnergyFlow_H
