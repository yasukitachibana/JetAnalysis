...
if(FASTJET)
    ...
    if(FASTJET_CONFIGLIBS)
        ...
        # NOTE: Temporarily disabling contrib to see if it works!
        #set(fjlibs "fastjetcontribfragile;fastjetplugins;siscone_spherical;siscone;fastjettools;fastjet")
        set(fjlibs "fastjet;fastjetplugins;fastjettools;siscone;siscone_spherical;Centauro;ClusteringVetoPlugin;ConstituentSubtractor;EnergyCorrelator;FlavorCone;GenericSubtractor;JetCleanser;JetFFMoments;JetsWithoutJets;LundPlane;Nsubjettiness;QCDAwarePlugin;RecursiveTools;ScJet;SoftKiller;SubjetCounting;ValenciaPlugin;VariableR")
